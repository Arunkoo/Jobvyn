      ...
      <CardHeader className="space-y-4 pb-4">
        <div className="flex items-start justify-between gap-3">
          ...
          <Link href={`/company/${job.company_id}`} className="shrink-0">
            <div className="relative w-14 h-14 rounded-xl border-2 overflow-hidden hover:scale-105 transition-transform bg-background">
              <Image
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-sm">
            <div className="flex item-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-600">
              <MapPin size={14} />
